...
Perl:
 ...
 Text::Tmpl::register_simple("name", \&simple_handler);
 sub simple_handler {
 ...
 Text::Tmpl::register_pair($is_named, "open",
                                   "close", \&pair_handler);
 sub pair_handler {
     my($context, $name, @args) = @_;
...
C:
 ...
 int template_register_pair(char named_context,
...
Note that tags are all global in scope - a tag can be registered at any
